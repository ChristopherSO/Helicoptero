 ...
 */
public class CambiadorGravedadInversa extends CambiadorDeEstados {

    // Constructor
    public CambiadorGravedadInversa(int x, int y, int alturaPanel) {
    ...
    public void draw(Canvas canvas) {
        ...
        // Dibujar texto
        canvas.drawText("GRAVEDAD", x + 40, y + 70, this.getFuenteTexto());
        canvas.drawText("INVERSA", x + 46, y + 90, this.getFuenteTexto());
        }
