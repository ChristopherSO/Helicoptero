 ...
 */
public class CambiadorEscudoPlus extends CambiadorDeEstados {

    // Atributos
    private Paint estiloAnilloCirculo;


    // Constructor
    public CambiadorEscudoPlus(int x, int y, PanelJuego panelJuego) {
        super(
                BitmapFactory.decodeResource(panelJuego.getResources(), R.drawable.cambiador_escudo_plus_),
                12,
                x,
                y,
                90,
