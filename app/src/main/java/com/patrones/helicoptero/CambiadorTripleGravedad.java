 ...
 */
public class CambiadorTripleGravedad extends CambiadorDeEstados {

    // Constructor
    public CambiadorTripleGravedad(int x, int y, int alturaPanel) {
    ...
    public void cambiarEstado(Helicoptero helicoptero) {
        ...
        helicoptero.setEstado(new EstadoTripleGravedad(helicoptero));
    }
